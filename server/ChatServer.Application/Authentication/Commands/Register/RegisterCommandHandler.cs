...
using RequestResult = ChatServer.Application.Authentication.Common.AuthenticationResult;

namespace ChatServer.Application.Authentication.Commands.Register
{
