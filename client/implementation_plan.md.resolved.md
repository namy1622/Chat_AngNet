...
*   **Inputs**:
    ...
    - `size`: `xs` (24px), `sm` (32px), [md](file:///f:/ProjectAngular/Chat_AngNet/DB_CONFIG_GUIDE.md) (40px - chuẩn), `lg` (56px).
...
*   **Inputs**:
    ...
    - `size`: `sm`, [md](file:///f:/ProjectAngular/Chat_AngNet/DB_CONFIG_GUIDE.md), `lg`.
...
*   **Inputs**:
    ...
    - `placeholder` (string).
    - `type`: [text](file:///f:/ProjectAngular/Chat_AngNet/server/ChatServer.Infrastructure/Data/ApplicationDbContext.cs#5-14), `password`, `email`.
